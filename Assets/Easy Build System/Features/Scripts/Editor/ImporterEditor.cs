...
{
    public const string VERSION = "Release 5.4";
    ...
    private void OnGUI()
    {
        ...
        if (float.Parse(Application.unityVersion.Substring(0, 6)) >= 2019.4f)
        {
        ...
        else
        {
            ...
            GUILayout.Label("Recommended 2019.4f or higher", GUILayout.Width(150));
            GUI.color = Color.white;
        }
