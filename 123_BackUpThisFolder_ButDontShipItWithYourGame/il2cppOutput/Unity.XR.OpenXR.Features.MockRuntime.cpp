...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MockRuntime_SetKeepFunctionCallbacks_m8E0E300D594B6DE823AE6800E23FC829AAD55EB4 (bool ___value0, const RuntimeMethod* method) 
{
	...
	// Native function invocation
	#if FORCE_PINVOKE_INTERNAL || FORCE_PINVOKE_mock_api_INTERNAL
	reinterpret_cast<PInvokeFunc>(MockRuntime_SetKeepFunctionCallbacks)(static_cast<int8_t>(___value0));
	#else
	il2cppPInvokeFunc(static_cast<int8_t>(___value0));
	#endif
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool MockRuntime_Internal_TransitionToState_m5D9A59AAF1E0CF512791ADE220FB09DF70109BFF (int32_t ___state0, bool ___forceTransition1, const RuntimeMethod* method) 
{
	...
	// Native function invocation
	#if FORCE_PINVOKE_INTERNAL || FORCE_PINVOKE_mock_api_INTERNAL
	int8_t returnValue = reinterpret_cast<PInvokeFunc>(MockRuntime_TransitionToState)(___state0, static_cast<int8_t>(___forceTransition1));
	#else
	int8_t returnValue = il2cppPInvokeFunc(___state0, static_cast<int8_t>(___forceTransition1));
	#endif
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MockRuntime_ActivateSecondaryView_mEA131BD49CD0DDD69B6AFCD7DCBC0250B36F19D9 (int32_t ___viewConfigurationType0, bool ___activate1, const RuntimeMethod* method) 
{
	...
	// Native function invocation
	#if FORCE_PINVOKE_INTERNAL || FORCE_PINVOKE_mock_api_INTERNAL
	reinterpret_cast<PInvokeFunc>(MockRuntime_ActivateSecondaryView)(___viewConfigurationType0, static_cast<int8_t>(___activate1));
	#else
	il2cppPInvokeFunc(___viewConfigurationType0, static_cast<int8_t>(___activate1));
	#endif
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MockRuntime_MetaPerformanceMetrics_SeedCounterOnce_Float_m36A5817DD1A8817E727EC2389953495B6AFB5023 (String_t* ___xrPathString0, float ___value1, uint32_t ___unit2, const RuntimeMethod* method) 
{
